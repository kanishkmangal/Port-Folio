...
export default function Achievements() {
    return (
        <section id="achievements" className="container py-20 flex flex-col justify-center">
            ...
            <div className="max-w-3xl mx-auto w-full space-y-6">
                {achievements.map((achievement, index) => (
                    <div key={index} className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl hover:border-yellow-500/30 transition-all hover:shadow-lg flex items-start gap-4 group">
