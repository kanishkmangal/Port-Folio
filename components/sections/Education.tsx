...
export default function Education() {
    return (
        <section id="education" className="container py-20 flex flex-col justify-center">
            ...
            <div className="max-w-4xl mx-auto w-full relative">
                ...
                <div className="space-y-12">
                    {education.map((edu, index) => (
                        <div key={index} className={`relative flex flex-col md:flex-row items-start ${index % 2 === 0 ? 'md:justify-start' : 'md:justify-end'}`}>
